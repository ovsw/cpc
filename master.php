	...
	<div class="cloudsRight"></div>
		...
		<div class="contentWrapper">
			...
			switch ($page->template) {
				case 'home':
					require ("./layout/home.inc");
					break;
				case 'basic-page':
					$contentTemplate = "./content/basic-page.inc";
					require ("./layout/left-sidebar.inc");
					break;
				case 'accommodations-page':
					$contentTemplate = "./content/accommodations-page.inc";
					require ("./layout/left-sidebar.inc");
					break;
				case 'events':
					$contentTemplate = "./content/events-page.inc";
					require ("./layout/left-sidebar.inc");
					break;
				case 'event':
					$contentTemplate = "./content/event-page.inc";
					require ("./layout/left-sidebar.inc");
					break;
				case 'testimonials':
					$contentTemplate = "./content/testimonials-page.inc";
					require ("./layout/left-sidebar.inc");
					break;
				case 'youth-rates-page':
					$contentTemplate = "./content/testimonials-page.inc";
					require ("./layout/left-sidebar.inc");
					break;
				case 'news':
					$contentTemplate = "./content/news-page.inc";
					require ("./layout/left-sidebar.inc");
					break;
				case 'news-item':
					$contentTemplate = "./content/news-item.inc";
					require ("./layout/left-sidebar.inc");
					break;
				case 'store-home':
					$contentTemplate = "./content/store-home.inc";
					require ("./layout/store.inc");
					break;
				case 'product':
					$contentTemplate = "./content/store-product.inc";
					require ("./layout/store.inc");
					break;
				case 'interactive-map':
					$contentTemplate = "./content/interactive-map.inc";
					require ("./layout/left-sidebar.inc");
					break;
				case 'interactive-map2':
					$contentTemplate = "./content/interactive-map2.inc";
					require ("./layout/left-sidebar.inc");
					break;
				case 'irm':
					$contentTemplate = "./content/irm.inc";
					require ("./layout/left-sidebar.inc");
					break;
				case 'events-calendar':
					$contentTemplate = "./content/events-calendar.inc";
					require ("./layout/left-sidebar.inc");
					break;
				default:
					require ("./layout/home.inc");
