...
<div data-pw-id="main-column">
  ...
  <?php if ($page->news_cover_photo) : ?>
        <img class="coverThumbnailEventPage" src="<?= $page->news_cover_photo->getCrop("news_page_thumbnail")->url; ?>" alt="<?= $page->news_cover_photo->description ?>" />
        <?php else: ?>
